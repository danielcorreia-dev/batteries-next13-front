...
const DeleteUser = () => {
  ...
  const handleConfirm = async () => {
    ...
    const res = await fetch(`/nest-api/users/${session?.user.id}`, {
      method: "DELETE",
      headers: {
          ...
          <div className="flex flex-col rounded-xl border bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:shadow-slate-700/[.7]">
            ...
            <div className="overflow-y-auto p-4">
              <p className="text-gray-800 dark:text-gray-400">
                Você tem certeza que deseja <b>deletar</b> a sua conta por
                completo? Todos os seus dados incluindo conquistas, descartes e
                pontos serão perdidos <b>permanentemente</b>.
              </p>
            </div>
