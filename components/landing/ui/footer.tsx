  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        {/* Top area: Blocks */}
        <div className="flex flex-col justify-around gap-8 border-t border-gray-200 py-8 md:flex-row md:py-12">
          {/* 1st block */}
          <div className="mb-2 md:mb-0">
            <div className="mb-2">
              <Logo />
            </div>
            <div className="break-before-auto flex-wrap text-sm text-gray-600">
              <p>
                Batteries Project é uma plataforma que visa ajudar o meio
                ambiente ao reciclar baterias e descartes de medicamentos.
              </p>
            </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="mb-2 font-medium text-gray-800">Projeto</h6>
        ...
        <div className="border-t border-gray-200 py-4 md:flex md:items-center md:justify-between md:py-8">
          ...
          <div className="mr-4 text-sm text-gray-600">
            &copy; Batteries Project. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
