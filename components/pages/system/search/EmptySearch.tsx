const EmptySearch = () => {
  return (
    <div className="flex min-h-[15rem] max-w-5xl flex-col rounded-xl border bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800 dark:shadow-slate-700/[.7]">
      <div className="flex flex-auto flex-col items-center justify-center p-4 md:p-5">
        ...
        <p className="mt-5 text-sm text-gray-500 dark:text-neutral-300/80">
